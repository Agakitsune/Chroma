...
CursorManager::CursorManager() noexcept
{
    ...
    cursors[(size_t)Cursor::Default] = SDL_CreateCursor(arrow_data, arrow_mask, 16, 16, 0, 0);

    cursors[(size_t)Cursor::Cross] = SDL_CreateCursor(cross_data, cross_mask, 16, 16, 8, 8);

    cursors[(size_t)Cursor::Grab] = SDL_CreateCursor(grab_data, grab_mask, 16, 16, 8, 8);

    cursors[(size_t)Cursor::Picker] = SDL_CreateCursor(picker_data, picker_mask, 16, 16, 0, 15);

    cursors[(size_t)Cursor::Point] = SDL_CreateCursor(point_data, point_mask, 16, 16, 6, 0);
