...
void EraseCommand::add(const SDL_Point &point, const Color &color) noexcept {
...
void EraseCommand::start(const Canvas &canvas, const SDL_Point &p,
                         const Color &color) noexcept {
  add(p, color);
}

void EraseCommand::update(const Canvas &canvas, const SDL_Point &p,
                          const Color &color) noexcept {
  if (!contains(p)) {
    add(p, color);
  }
...
void EraseCommand::end(const Canvas &canvas, const SDL_Point &p,
                       const Color &color) noexcept {
