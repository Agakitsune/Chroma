...
void BrushCommand::add(const SDL_Point &point, const Color &color) noexcept {
...
void BrushCommand::start(const Canvas &canvas, const SDL_Point &p,
                         const Color &color) noexcept {
  add(p, color);
}

void BrushCommand::update(const Canvas &canvas, const SDL_Point &p,
                          const Color &color) noexcept {
  if (!contains(p)) {
    add(p, color);
  }
...
void BrushCommand::end(const Canvas &canvas, const SDL_Point &p,
                       const Color &color) noexcept {
