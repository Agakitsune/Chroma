...
void SelectMoveCommand::start(const Canvas &canvas, const SDL_Point &p,
                              const Color &color) noexcept {
  s = p;
  e = p;
...
void SelectMoveCommand::update(const Canvas &canvas, const SDL_Point &p,
                               const Color &color) noexcept {
  // if (e.x != p.x && e.y != p.y) {
  SDL_Point delta{
      p.x - e.x,
...
void SelectMoveCommand::end(const Canvas &canvas, const SDL_Point &p,
                            const Color &color) noexcept {
