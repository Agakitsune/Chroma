...
void SelectMarkCommand::start(const Canvas &canvas, const SDL_Point &p,
                              const Color &color) noexcept {
  s = p;
  rect.w = 0;
}

void SelectMarkCommand::update(const Canvas &canvas, const SDL_Point &p,
                               const Color &color) noexcept {
  e = p;
...
void SelectMarkCommand::end(const Canvas &canvas, const SDL_Point &p,
                            const Color &color) noexcept {
