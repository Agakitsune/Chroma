...
void ShapeCommand::update(const SDL_Point &point,
...
void ShapeCommand::discard(SDL_Rect &selection) noexcept { rect.w = 0; }

void ShapeCommand::render(SDL_Texture *preview, SDL_Texture *overlay,
                          SDL_Rect &selection) noexcept {
