...
namespace chroma {
    ...
    void SelectMarkCommand::redo(SDL_Rect &selection) noexcept {
        selection = rect;
    }
    ...
    void SelectMarkCommand::start(const SDL_Point &point, SDL_Rect &selection) noexcept {
        previous = selection;
    ...
    void SelectMarkCommand::update(const SDL_Point &point, SDL_Rect &selection) noexcept {
        e = point;
    ...
    void SelectMarkCommand::end(const SDL_Point &point, SDL_Rect &selection) noexcept {
    ...
    void SelectMarkCommand::discard(SDL_Rect &selection) noexcept {
        rect.w = 0;
    }

    void SelectMarkCommand::render(SDL_Texture *preview, SDL_Texture *overlay, SDL_Rect &selection) noexcept {
